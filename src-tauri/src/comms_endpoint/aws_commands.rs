...
#[tauri::command]
pub async fn get_data_for_class(project_name:&str, dep_name:&str)-> Result<String, String>{
    let images = aws_service::get_data_for_class(project_name, dep_name).await
